...
setup(
    ...
    url = "https://github.com/Weber-JC/PythonEggs/tree/master/weberWinSV",  #这个包的项目地址
    license = "MIT", #授权方式,

    # zip_safe=True,
    zip_safe = False,

    description = 'Supervisor for Windows wrote by Weber Juche.',
    ...
    install_requires=[
        # WeiYF.20160719 为避免本地安装时强制更新，这里不列入依赖。
        # "requests",
    ], # 所依赖的PyPi包
